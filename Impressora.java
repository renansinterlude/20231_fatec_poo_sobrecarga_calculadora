...
public class Impressora {
    ...
    public void exibir(float a, String b){
        System.out.println(a + ", " + parseFloat(b));
    }
    public void exibir(String a, float b){
        System.out.println(parseFloat(a)+ ", " + b);
    }
    public void exibir(String a, String b, String c){
        System.out.println(parseFloat(a) + ", " + parseFloat(b) + ", " + parseFloat(c));
    }
    public void exibir(int a, int b, String c){
        System.out.println(a + ", " + b + ", " + parseInt(c));
    }
}